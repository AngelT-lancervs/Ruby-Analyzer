...
_lr_productions = [
  ...
  ('codigo -> puts','codigo',1,'p_codigo','sintax_analyzer.py',8),
  ('codigo -> gets','codigo',1,'p_codigo','sintax_analyzer.py',9),
  ('codigo -> estructurasDatos','codigo',1,'p_codigo','sintax_analyzer.py',10),
  ('codigo -> estructurasControl','codigo',1,'p_codigo','sintax_analyzer.py',11),
  ('estructurasDatos -> array','estructurasDatos',1,'p_estructurasDatos','sintax_analyzer.py',15),
  ('estructurasDatos -> var_arreglo','estructurasDatos',1,'p_estructurasDatos','sintax_analyzer.py',16),
  ('estructurasDatos -> acceder_arreglo','estructurasDatos',1,'p_estructurasDatos','sintax_analyzer.py',17),
  ('estructurasControl -> ifStatement','estructurasControl',1,'p_estructurasControl','sintax_analyzer.py',22),
  ('value -> var','value',1,'p_value','sintax_analyzer.py',27),
  ('value -> num','value',1,'p_value','sintax_analyzer.py',28),
  ('value -> STRING','value',1,'p_value','sintax_analyzer.py',29),
  ('value -> NIL','value',1,'p_value','sintax_analyzer.py',30),
  ('value -> SYMBOL','value',1,'p_value','sintax_analyzer.py',31),
  ('values_space -> value SPACE values_space','values_space',3,'p_values_space','sintax_analyzer.py',35),
  ('values_space -> value','values_space',1,'p_values_space','sintax_analyzer.py',36),
  ('values -> value','values',1,'p_values','sintax_analyzer.py',40),
  ('values -> value COMMA values','values',3,'p_values','sintax_analyzer.py',41),
  ('var -> LOCAL_VAR','var',1,'p_var','sintax_analyzer.py',45),
  ('var -> INSTANCE_VAR','var',1,'p_var','sintax_analyzer.py',46),
  ('var -> CLASS_VAR','var',1,'p_var','sintax_analyzer.py',47),
  ('var -> GLOBAL_VAR','var',1,'p_var','sintax_analyzer.py',48),
  ('var -> CONSTANT','var',1,'p_var','sintax_analyzer.py',49),
  ('num -> FLOAT','num',1,'p_num','sintax_analyzer.py',53),
  ('num -> INTEGER','num',1,'p_num','sintax_analyzer.py',54),
  ('gets -> GETS DOT CHOMP DOT TO_F','gets',5,'p_gets','sintax_analyzer.py',58),
  ('gets -> GETS DOT CHOMP DOT TO_I','gets',5,'p_gets','sintax_analyzer.py',59),
  ('gets -> GETS DOT CHOMP','gets',3,'p_gets','sintax_analyzer.py',60),
  ('puts -> PUT values','puts',2,'p_puts','sintax_analyzer.py',64),
  ('array -> array_explicito','array',1,'p_array','sintax_analyzer.py',69),
  ('array -> array_implicito','array',1,'p_array','sintax_analyzer.py',70),
  ('array -> array_creation','array',1,'p_array','sintax_analyzer.py',71),
  ('array -> newArray','array',1,'p_array','sintax_analyzer.py',72),
  ('array_explicito -> LEFT_COR values RIGHT_COR','array_explicito',3,'p_array_explicito','sintax_analyzer.py',76),
  ('array_explicito -> LEFT_COR RIGHT_COR','array_explicito',2,'p_array_explicito','sintax_analyzer.py',77),
  ('array_implicito -> PERCENTW LEFT_COR values_space RIGHT_COR','array_implicito',4,'p_array_implicito','sintax_analyzer.py',81),
  ('array_implicito -> PERCENTW LEFT_COR RIGHT_COR','array_implicito',3,'p_array_implicito','sintax_analyzer.py',82),
  ('array_creation -> ARRAY LEFTPAR array_explicito RIGHTPAR','array_creation',4,'p_array_creation','sintax_analyzer.py',86),
  ('newArray -> ARRAY DOT NEW','newArray',3,'p_newArray','sintax_analyzer.py',90),
  ('newArray -> ARRAY DOT NEW LEFTPAR INTEGER RIGHTPAR','newArray',6,'p_newArray','sintax_analyzer.py',91),
  ('newArray -> ARRAY DOT NEW LEFTPAR INTEGER COMMA values RIGHTPAR','newArray',8,'p_newArray','sintax_analyzer.py',92),
  ('var_arreglo -> var','var_arreglo',1,'p_var_arreglo','sintax_analyzer.py',96),
  ('var_arreglo -> var ASSIGN array','var_arreglo',3,'p_var_arreglo','sintax_analyzer.py',97),
  ('acceder_arreglo -> var_arreglo LEFT_COR INTEGER RIGHT_COR','acceder_arreglo',4,'p_acceder_arreglo','sintax_analyzer.py',101),
  ('ifStatement -> IF condiciones COLON codigo','ifStatement',4,'p_ifStatement','sintax_analyzer.py',106),
  ('ifStatement -> IF condiciones COLON codigo else_statement','ifStatement',5,'p_ifStatement','sintax_analyzer.py',107),
  ('condiciones -> condicion','condiciones',1,'p_condiciones','sintax_analyzer.py',111),
  ('condiciones -> condiciones conectores condiciones','condiciones',3,'p_condiciones','sintax_analyzer.py',112),
  ('conectores -> AND AND','conectores',2,'p_conectores','sintax_analyzer.py',116),
  ('conectores -> OR OR','conectores',2,'p_conectores','sintax_analyzer.py',117),
  ('condicion -> num operComp num','condicion',3,'p_condicion','sintax_analyzer.py',121),
  ('operComp -> GREATER','operComp',1,'p_operComp','sintax_analyzer.py',125),
  ('operComp -> LESS','operComp',1,'p_operComp','sintax_analyzer.py',126),
  ('operComp -> GREATER_EQUAL','operComp',1,'p_operComp','sintax_analyzer.py',127),
  ('operComp -> LESS_EQUAL','operComp',1,'p_operComp','sintax_analyzer.py',128),
  ('operComp -> EQUAL','operComp',1,'p_operComp','sintax_analyzer.py',129),
  ('operComp -> NOT_EQUAL','operComp',1,'p_operComp','sintax_analyzer.py',130),
  ('operComp -> COMPARE','operComp',1,'p_operComp','sintax_analyzer.py',131),
  ('else_statement -> ELSE COLON codigo','else_statement',3,'p_else_statement','sintax_analyzer.py',135),
]
